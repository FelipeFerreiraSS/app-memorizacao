        ...
        <header className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {isOpen && (
                        <div className={`w-full mt-32 bg-white ${isOpen ? 'block' : 'hidden'}`}>
                            <ul className="grid gap-5 justify-items-end text-sm">
                                <li>
                                    <button
                                        onClick={toggleDropdown}
                                        className="rounded w-10 rounded-md bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75"
                                    >
                                        <Image
                                        className='h-5 w-5'
                                        src={close}
                                ...
                                <a
                                    onClick={toggleDropdown}
                                    className="mb-5 rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700"
                                    href="/#functions"
                                >
                                    Funçôes
                                </a>
